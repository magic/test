...
export default [
  ...
  {
    fn: async () => {
      const { target, unmount } = await mount('./src/lib/svelte/components/EnvTest.svelte')
  ...
  {
    fn: async () => {
      const { target, unmount } = await mount('./src/lib/svelte/components/StateTest.svelte')
      const result = html(target)
      await unmount()
      return result
    },
  ...
  {
    fn: async () => {
      const { target, unmount } = await mount('./src/lib/svelte/components/PathsTest.svelte')
      await flushSyncSvelte()
  ...
  {
    fn: async () => {
      const { target, unmount } = await mount('./src/lib/svelte/components/UsesAppImports.svelte')
      const result = html(target)
      await unmount()
      return result
    },
  ...
  {
    fn: async () => {
      const { unmount } = await mount('./src/lib/svelte/components/NavTest.svelte')
      await unmount()
      return true
    },
    expect: true,
